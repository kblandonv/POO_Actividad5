...
public class Piramide extends FiguraGeometrica {
    ...
    private final double altura; /* Atributo que identifica la altura de una pirámide */

    private final double apotema; /* Atributo que identifica el apotema de una pirámide */
