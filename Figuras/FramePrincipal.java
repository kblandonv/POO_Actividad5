 ...
 * @version 1.2/2020
 */
public class FramePrincipal extends JFrame implements
        ActionListener {
    ...
    public void actionPerformed(ActionEvent evento) {
        if (evento.getSource() == esfera) { // Si se pulsa el botón esfera
            FrameEsfera esfera = new FrameEsfera(); /* Crea la ventana de la esfera */
        ...
        if (evento.getSource() == cilindro) { /* Si se pulsa el botón cilindro */
            FrameCilindro cilindro = new FrameCilindro(); /* Crea la ventana del cilindro */
        ...
        if (evento.getSource() == piramide) { /* Si se pulsa el botón pirámide */
            FramePiramide piramide = new FramePiramide(); /* Crea la ventana de la pirámide */
            piramide.setVisible(true); /* Establece que se visualice la ventana de la pirámide */
        }
    }
}